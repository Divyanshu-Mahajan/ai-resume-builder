...
import classes from './MinimalistResume.module.css';
                  ...
                  experience.map((exp, index) => (
                    <li className={classes.experienceItem} key={index}>
                      <div className={classes.experienceInfo}>
                        <h3>{exp.company || "Company"} - {exp.jobTitle || "Role"}</h3>
                        <p>{exp.location || "Location"} | {exp.startDate || "(dd-mm-yyyy)"} - {exp.endDate || 'Present'}</p>
                  ...
                  education.map((edu, index ) => (
                    <li className={classes.educationItem} key={index}>
                      <div className={classes.educationInfo}>
                        ...
                        <p>{edu.startDate || "(dd-mm-yyyy)"} - {edu.endDate || 'Present'} | CGPA: {edu.grade || "grade"}</p>
                  ...
                  projects.map((proj, index ) => (
                    <li className={classes.projectItem} key={index}>
                      <div className={classes.projectInfo}>
                        ...
                        <p><strong>Technologies: {proj.technologies || "Technology used"}</strong></p>
                  ...
                  certification.map((certi, index) => (
                    <li className={classes.certificationItem} key={index}>
                      <div className={classes.certificationInfo}>
                        <h3>{certi.title || "Certifictae Name"}</h3>
                        <p>{certi.issuer || "Name of the issuer"} - {certi.date}</p>
